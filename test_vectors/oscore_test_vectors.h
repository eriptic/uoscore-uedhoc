...
const uint8_t T1__MASTER_SECRET[16] = { 0x01, 0x02, 0x03, 0x04,
					       0x05, 0x06, 0x07, 0x08,
					       0x09, 0x0a, 0x0b, 0x0c,
					       0x0d, 0x0e, 0x0f, 0x10 };
...
const uint8_t T1__COAP_REQ[] = { 0x44, 0x01, 0x5d, 0x1f, 0x00, 0x00,
					0x39, 0x74, 0x39, 0x6c, 0x6f, 0x63,
...
const uint8_t T1__COMMON_IV[] = { 0x46, 0x22, 0xd4, 0xdd, 0x6d,
					 0x94, 0x41, 0x68, 0xee, 0xfb,
					 0x54, 0x98, 0x7c };
uint8_t T1__COMMON_IV_LEN = sizeof(T1__COMMON_IV);

const uint8_t T1__OSCORE_REQ[] = {
 ...
 */
const uint8_t T2__MASTER_SECRET[16] = { 0x01, 0x02, 0x03, 0x04,
					       0x05, 0x06, 0x07, 0x08,
					       0x09, 0x0a, 0x0b, 0x0c,
					       0x0d, 0x0e, 0x0f, 0x10 };
...
const uint8_t T2__COAP_RESPONSE[] = { 0x64, 0x45, 0x5d, 0x1f, 0x00, 0x00,
					     0x39, 0x74, 0xff, 0x48, 0x65, 0x6c,
					     0x6c, 0x6f, 0x20, 0x57, 0x6f, 0x72,
					     0x6c, 0x64, 0x21 };
uint8_t T2__COAP_RESPONSE_LEN = sizeof(T2__COAP_RESPONSE);

/*Expected result*/
/*the  reconstructed coap request see Appendix C4*/
const uint8_t T2__COAP_REQ[] = { 0x44, 0x01, 0x5d, 0x1f, 0x00, 0x00,
					0x39, 0x74, 0x39, 0x6c, 0x6f, 0x63,
					0x61, 0x6c, 0x68, 0x6f, 0x73, 0x74,
					0x83, 0x74, 0x76, 0x31 };
uint8_t T2__COAP_REQ_LEN = sizeof(T2__COAP_REQ);

const uint8_t T2__OSCORE_RESP[] = {
...
const uint8_t T3__MASTER_SECRET[16] = { 0x01, 0x02, 0x03, 0x04,
					       0x05, 0x06, 0x07, 0x08,
					       0x09, 0x0a, 0x0b, 0x0c,
					       0x0d, 0x0e, 0x0f, 0x10 };
...
const uint8_t T3__COAP_REQ[] = { 0x44, 0x01, 0x71, 0xc3, 0x00, 0x00,
					0xb9, 0x32, 0x39, 0x6c, 0x6f, 0x63,
					0x61, 0x6c, 0x68, 0x6f, 0x73, 0x74,
					0x83, 0x74, 0x76, 0x31 };
...
const uint8_t T4__MASTER_SECRET[16] = { 0x01, 0x02, 0x03, 0x04,
					       0x05, 0x06, 0x07, 0x08,
					       0x09, 0x0a, 0x0b, 0x0c,
					       0x0d, 0x0e, 0x0f, 0x10 };
...
const uint8_t T4__COMMON_IV[] = { 0xbe, 0x35, 0xae, 0x29, 0x7d,
...
const uint8_t T5__MASTER_SECRET[16] = { 0x01, 0x02, 0x03, 0x04,
					       0x05, 0x06, 0x07, 0x08,
					       0x09, 0x0a, 0x0b, 0x0c,
					       0x0d, 0x0e, 0x0f, 0x10 };
...
const uint8_t T5__COAP_REQ[] = { 0x44, 0x01, 0x2f, 0x8e, 0xef, 0x9b,
					0xbf, 0x7a, 0x39, 0x6c, 0x6f, 0x63,
					0x61, 0x6c, 0x68, 0x6f, 0x73, 0x74,
					0x83, 0x74, 0x76, 0x31 };
 ...
 */
const uint8_t T6__MASTER_SECRET[16] = { 0x01, 0x02, 0x03, 0x04,
					       0x05, 0x06, 0x07, 0x08,
					       0x09, 0x0a, 0x0b, 0x0c,
					       0x0d, 0x0e, 0x0f, 0x10 };
...
const uint8_t T6__COMMON_IV[] = { 0x2c, 0xa5, 0x8f, 0xb8, 0x5f,
					 0xf1, 0xb8, 0x1c, 0x0b, 0x71,
					 0x81, 0xb8, 0x5e };
 ...
 */
const uint8_t T7__MASTER_SECRET[16] = { 0x01, 0x02, 0x03, 0x04,
					       0x05, 0x06, 0x07, 0x08,
					       0x09, 0x0a, 0x0b, 0x0c,
					       0x0d, 0x0e, 0x0f, 0x10 };
...
const uint8_t T7__COAP_RESPONSE[] = { 0x64, 0x45, 0x5d, 0x1f, 0x00, 0x00,
					     0x39, 0x74, 0xff, 0x48, 0x65, 0x6c,
					     0x6c, 0x6f, 0x20, 0x57, 0x6f, 0x72,
					     0x6c, 0x64, 0x21 };
 ...
 */
const uint8_t T8__MASTER_SECRET[16] = { 0x01, 0x02, 0x03, 0x04,
					       0x05, 0x06, 0x07, 0x08,
					       0x09, 0x0a, 0x0b, 0x0c,
					       0x0d, 0x0e, 0x0f, 0x10 };
...
// const uint8_t *T8__RECIPIENT_ID = NULL;
...
//const uint8_t *T8__ID_CONTEXT = NULL;
